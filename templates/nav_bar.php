	...
	<div class="container-fluid">
		<div class="navbar-header">
			...
			<a class="navbar-brand" style="padding-bottom: 0em; padding-top: 0em;" href="<?php echo $pathToRoot; ?>">
				<img id="brand-img" src="<?php echo $pathToRoot; ?>assets/images/ml-logo.png">
				<font style="display: inline-block;vertical-align: sub;">MotionLab</font>
			</a>
		</div>
	    <div class="collapse navbar-collapse">
	      <ul class="nav navbar-nav navbar-right">
	        <li <?php if($thisPage == "home"){ echo 'class="active"'; } ?>><a href="<?php echo $pathToRoot; ?>index.php">Home</a></li>
	        <li <?php if($thisPage == "guide"){ echo 'class="active"'; } ?>><a href="<?php echo $pathToRoot; ?>guide.php">Guide</a></li>
