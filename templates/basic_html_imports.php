...
<link href="<?php echo $pathToRoot; ?>css/slick.css" rel="stylesheet" type="text/css">
<link href="<?php echo $pathToRoot; ?>css/animate.css" rel="stylesheet" type="text/css">
...
<script src="<?php echo $pathToRoot; ?>js/slick.min.js"></script>
<script src="<?php echo $pathToRoot; ?>js/noframework.waypoints.min.js"></script>
